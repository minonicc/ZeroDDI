...
class classifier(nn.Module):
    def __init__(self, leftmodel, rightmodel,temperature=0.9,
                ...
                instanse_uni_loss=True, class_uni_loss = True,
                 ...
                 matching_pharmacophore_top_k_aggregation='softmax',
                 matching_pharmacophore_use_null_evidence=None,
                 matching_pharmacophore_use_drug_nodes=False,
        ...
        if self.matching_mode == 'reverse':
            ...
            self.ReverseMatcher = ReverseAttentionCandidateMatcher(
                ...
                pharmacophore_top_k_aggregation=matching_pharmacophore_top_k_aggregation,
                pharmacophore_use_null_evidence=matching_pharmacophore_use_null_evidence,
                pharmacophore_use_drug_nodes=matching_pharmacophore_use_drug_nodes,
                pharmacophore_drug_top_k=matching_pharmacophore_drug_top_k,
                pharmacophore_drug_pair_top_k=matching_pharmacophore_drug_pair_top_k,
