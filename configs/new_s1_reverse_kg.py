...
knowddi_all_file = './data/KnowDDI/drugbank_true_s1/DDI_final1.5.csv'
knowddi_split_dir = './data/KnowDDI/drugbank_true_s1'
knowddi_output_dir = './data/KnowDDI/output_s0/'
kg_pair_file = './data/KnowDDI/drugbank_true_s1/kg/molecbionet_pair_kg_s1.json'
...
work_dir = './work_dirs/new_s1_reverse_kg'
