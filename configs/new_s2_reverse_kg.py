...
knowddi_all_file = './data/KnowDDI/drugbank_true_s2/DDI_final1.5.csv'
knowddi_split_dir = './data/KnowDDI/drugbank_true_s2'
knowddi_output_dir = './data/KnowDDI/output_s0/'
kg_pair_file = './data/KnowDDI/drugbank_true_s2/kg/molecbionet_pair_kg_s2.json'
...
work_dir = './work_dirs/new_s2_reverse_kg'
